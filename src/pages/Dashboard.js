...
const Dashboard = () => {
  ...
  return (
    ...
    >
      {/* jodi loggedin kora user er create kora kono tour na thake taile ei message dibe */}
      {userTours.length === 0 && (
        <h3>No tour available with the user: {user?.result?.name}</h3>
      )}
      {/* jodi loggedin kora user er create kora tour thake taile opore headline dewkabe ex: Dashboard: Nazim */}
      {userTours.length > 0 && (
        <>
